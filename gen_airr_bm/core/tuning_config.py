class TuningConfig:
    def __init__(self, tuning_method: str, model_names: list, reference_data: list, tuning_output_dir: str, root_output_dir: str):
    ...
    def __repr__(self):
        return (f"TuningConfig(tuning_method={self.tuning_method}, model_names={self.model_names}, "
                ...
                f"root_output_dir={self.root_output_dir})")
